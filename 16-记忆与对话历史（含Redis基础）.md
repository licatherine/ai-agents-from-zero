...
**前置知识建议：** 建议已学习 [第 11 章 Model I/O](11-Model-I-O与模型接入.md)、[第 13 章 提示词与消息模板](13-提示词与消息模板.md)、[第 15 章 LCEL 与链式调用](15-LCEL与链式调用.md)。因为本章的核心，其实就是在已有“Prompt + Model + Chain”的基础上，再补上一层“历史消息管理”。
