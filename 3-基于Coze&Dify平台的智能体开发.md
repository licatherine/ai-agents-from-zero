...
<img src="images/3/3-1-2-1.png" style="zoom:67%;" />
...
<img src="images/3/3-1-4-1.png" style="zoom: 80%;" />
...
<img src="images/3/3-1-5-5.png" style="zoom:85%;" />

<img src="images/3/3-1-5-6.png" style="zoom:68%;" />
...
#### ① 创建智能体
 ...
 <img src="images/3/3-4-4-1.png" style="zoom:67%;" />
...
```
 ...
 <img src="images/3/3-4-4-3.png" style="zoom:80%;" />

 <img src="images/3/3-4-4-4.png" style="zoom:80%;" />
...
#### ③ 模型参数设置
 ...
 <img src="images/3/3-4-4-5.png" style="zoom: 67%;" />

关于 temperature（温度）：

<img src="images/3/3-4-4-6-temperature.jpg" alt="temperature的理解" style="zoom: 20%;" />
...
#### ④ 测试
 ...
 <img src="images/3/3-4-4-7.png" style="zoom:67%;" />

#### ⑤ 设置开场白及预设问题

 <img src="images/3/3-4-4-8.png" style="zoom:80%;" />

#### ⑥ 发布

 <img src="images/3/3-4-4-9.png" style="zoom:67%;" />

可以发布到多个平台：

 <img src="images/3/3-4-4-10.png" style="zoom: 67%;" />

 <img src="images/3/3-4-4-11.png" style="zoom:67%;" />
...
创建智能体：
 ...
 <img src="images/3/3-4-5-1.png" style="zoom:67%;" />

#### ② 填写提示词

 <img src="images/3/3-4-5-2.png" style="zoom:67%;" />
...
未使用插件时：
 ...
 <img src="images/3/3-4-5-3.png" style="zoom:80%;" />

安装插件：

 <img src="images/3/3-4-5-4.png" style="zoom: 67%;" />

继续搜索：

 <img src="images/3/3-4-5-5.png" style="zoom:67%;" />

 <img src="images/3/3-4-5-6.png" style="zoom:67%;" />

**插件 2：头条图片搜索**

![](images/3/3-4-5-7.png)

  <img src="images/3/3-4-5-8.png" style="zoom:67%;" />

#### ④ 使用知识库

 <img src="images/3/3-4-5-9.png" style="zoom:67%;" />

<img src="images/3/3-4-5-10.png" style="zoom: 67%;" />

<img src="images/3/3-4-5-11.png" style="zoom:80%;" />

 <img src="images/3/3-4-5-12.png" style="zoom: 67%;" />

 <img src="images/3/3-4-5-13.png" style="zoom:67%;" />
...
#### ① 创建智能体
 ...
 <img src="images/3/3-4-6-1.png" style="zoom:67%;" />

#### ② 填写提示词

![](images/3/3-4-6-2.png)

 <img src="images/3/3-4-6-3.png" style="zoom:67%;" />
...
在没有变量时，聊天中的上下文一旦清空，就没法获取之前的交互数据了。比如：
  ...
  <img src="images/3/3-4-6-4.png" style="zoom: 67%;" />
...
但清空记录以后：
 ...
 <img src="images/3/3-4-6-6.png" style="zoom:80%;" />

 <img src="images/3/3-4-6-7.png" style="zoom: 80%;" />

设置变量：

![](images/3/3-4-6-8.png)

 <img src="images/3/3-4-6-9.png" style="zoom:67%;" />

 <img src="images/3/3-4-6-10.png" style="zoom:80%;" />
...
![](images/3/3-4-6-11.png)
 ...
 <img src="images/3/3-4-6-12.png" style="zoom:80%;" />

 <img src="images/3/3-4-6-13.png" style="zoom: 57%;" />

 <img src="images/3/3-4-6-14.png" style="zoom:67%;" />
...
<img src="images/3/3-5-3-4.png" style="zoom:67%;" />
...
案例 1：详细过程见 [Coze 案例：一键生成行业调研 PPT](3-Coze&Dify平台工作流智能体案例与源码/3.1-Coze案例：一键生成行业调研PPT/3.1-一键生成行业调研PPT.md)

案例 2：详细过程见 [Coze 案例：复刻爆款视频](3-Coze&Dify平台工作流智能体案例与源码/3.2-Coze案例：复刻爆款视频/3.2-复刻爆款视频.md)
...
1、产品营销海报生成：[Coze](3-Coze&Dify平台工作流智能体案例与源码/3.3-Coze案例：产品营销海报生成/3.3-产品营销海报生成.md)

2、客户投诉分类助手：[Dify](3-Coze&Dify平台工作流智能体案例与源码/3.5-Dify案例：客户投诉分类助手/3.5-客户投诉分类助手.md)

3、一键生成行业调研报告：[Dify](3-Coze&Dify平台工作流智能体案例与源码/3.4-Dify案例：一键生成行业调研报告/3.4-一键生成行业调研报告.md)

4、客服对话记录分析：[Coze](3-Coze&Dify平台工作流智能体案例与源码/3.6-Coze案例：客服对话记录分析/3.6-客服对话记录分析-Coze.md) / [Dify](3-Coze&Dify平台工作流智能体案例与源码/3.7-Dify案例：客服对话记录分析/3.7-客服对话记录分析-Dify.md)

5、商品评论分析：[Coze](3-Coze&Dify平台工作流智能体案例与源码/3.8-Coze案例：商品评论分析/3.8-商品评论分析-商品评论分析-Coze.md) / [Dify](3-Coze&Dify平台工作流智能体案例与源码/3.9-Dify案例：商品评论分析/3.9-商品评论分析-Dify.md)

6、商品营销卖点提炼：[Coze](3-Coze&Dify平台工作流智能体案例与源码/3.10-Coze案例：商品营销卖点提炼/3.10-商品营销卖点提炼-Coze.md)
