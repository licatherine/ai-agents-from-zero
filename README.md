...
[仓库说明](README.md#📖-关于本仓库) • [教程亮点](README.md#✨-教程亮点（你将收获什么？）) • [教程大纲](README.md#📚-教程大纲) • [案例汇总](教程案例链接汇总.md#教程案例链接汇总源码与在线演示) • [技术栈概览](README.md#🛠-技术栈概览)
...
| 章节编号 | 章节名称                    | 内容概要                                                                         | 笔记链接                                              |
| -------- | --------------------------- | -------------------------------------------------------------------------------- | ----------------------------------------------------- |
| 01-1     | 大模型（LLM）认识与环境准备 | 起源与发展、AGI 关系、主流模型特点与适用场景、预训练/微调/推理                   | [→ 阅读](1-大模型智能体概述.md#第-1-章-认识大模型)    |
| 01-2     | 大模型架构原理              | Transformer、MoE、自注意力、LLaMA/Qwen/GPT、多模态                               | [→ 阅读](1-大模型智能体概述.md#14-大模型分类)         |
| 01-3     | 大模型调度平台              | Ollama、私有大模型调用、云端/本地部署（AWS、阿里云等）                           | [→ 阅读](1-大模型智能体概述.md#第-3-章大模型如何落地) |
| 01-4     | 提示词工程                  | 核心原则与结构、链式思维与 Few-shot、多轮对话与记忆、在 Agent 与工具调用中的应用 | [→ 阅读](1-大模型智能体概述.md#44-模块-1提示词工程)   |

### 02 企业低代码平台开发与项目实战

| 章节编号 | 章节名称                  | 内容概要                                                                           | 笔记链接                                                                       |
| -------- | ------------------------- | ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| 02-1     | Coze（扣子）平台          | 界面与功能、插件/知识库/工作流/智能体、Python 调用工作流                           | [→ 阅读](3-基于Coze&Dify平台的智能体开发.md#42-coze扣子介绍)                   |
| 02-2     | 项目 1：商户运营管家      | 行业调研 PPT、爆款视频复刻、营销海报、卖点提炼、评论分析                           | 待更新                                                                         |
| 02-3     | Dify AI 平台              | 工作流/Agent/知识库、多案例（投诉分类、调研报告、客服分析、评论分析）、Python 调用 | [→ 阅读](3-基于Coze&Dify平台的智能体开发.md#5-level-3通过-dify-搭建高阶智能体) |
| 02-4     | 容器化技术                | Docker 核心概念、安装与常用命令                                                    | 待更新                                                                         |
| 02-5     | 企业级大模型部署          | 腾讯云/阿里云、Docker、Dify、AutoDL、Ollama、Xinference、Coze 本地部署             | 待更新                                                                         |
| 02-6     | AI 代码编程工具 - Trae AI | 安装使用、多模型 API、MCP 接入                                                     | 待更新                                                                         |
| 02-7     | AI 代码编程工具 - Qoder   | 使用与调试、项目开发                                                               | 待更新                                                                         |

### 03 大模型核心开发框架

| 章节编号 | 章节名称                 | 内容概要                                                                    | 笔记链接 |
| -------- | ------------------------ | --------------------------------------------------------------------------- | -------- |
| 03-1     | LangChain 框架原理与应用 | Model I/O、Chains、Memory、Agents（ReAct）、Retrieval、电商商家对话助手案例 | 待更新   |
| 03-2     | LangGraph 框架原理与应用 | 图状思维、State/Node/Edge、持久化记忆、流式输出                             | 待更新   |
| 03-3     | MCP 从原理到实战         | 与 Function Calling 对比、通信机制、工作流程、Server 部署与自定义开发       | 待更新   |
| 03-4     | 跨 Agent 通信：A2A 协议  | 与 MCP 关系、消息与认证、典型场景                                           | 待更新   |

### 04 企业级 RAG / Agent 项目实战

| 章节编号 | 章节名称         | 内容概要                                                                                | 笔记链接 |
| -------- | ---------------- | --------------------------------------------------------------------------------------- | -------- |
| 04-1     | 项目 2：掌柜智库 | LangGraph RAG 工作流、MinerU/OCR、向量+稀疏+Neo4j 多路召回、HyDE/BGE-Rerank、RAGAS 评估 | 待更新   |
| 04-2     | 项目 3：电商小二 | 意图解析、多源知识库、流式回复、转人工机制、对话复盘、多渠道与监控                      | 待更新   |
| 04-3     | 项目 4：掌柜问数 | 自然语言转数据查询、多轮问数、权限适配、可视化输出                                      | 待更新   |
| 04-4     | 项目 5：市场罗盘 | 场景化任务拆解、从 0 到 1 设计与开发、阶段目标与进度管控、代码评审与成果展示            | 待更新   |

### 05 大模型微调实践

| 章节编号 | 章节名称                      | 内容概要                                                                                 | 笔记链接 |
| -------- | ----------------------------- | ---------------------------------------------------------------------------------------- | -------- |
| 05-1     | 大模型微调核心                | 数据与格式（Alpaca、ShareGPT）、PEFT/LoRA/QLoRA、全参数微调与 DeepSpeed、vLLM 部署、评估 | 待更新   |
| 05-2     | 企业级微调数据集构建          | 公开/私有数据、标注与质量、数据增强                                                      | 待更新   |
| 05-3     | 基于 Llama-Factory 的高效微调 | 环境与参数、单卡/多卡、Safetensors/ONNX                                                  | 待更新   |
| 05-4     | 调优案例                      | 多个完整案例                                                                             | 待更新   |

### 06 大厂开发规范

| 章节编号 | 章节名称           | 内容概要                                                              | 笔记链接 |
| -------- | ------------------ | --------------------------------------------------------------------- | -------- |
| 06-1     | 企业大模型研发流程 | 技术调研、方案与框架设计、RAG 与 pipeline、评估与角色、立项与需求文档 | 待更新   |
| 06-2     | 大模型当下热点     | Agent/RAG 主流技术、前沿与热点跟踪                                    | 待更新   |
