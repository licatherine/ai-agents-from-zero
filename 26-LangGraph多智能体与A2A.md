...
**学习建议：** 本章建议按 **“先分清 A2A / MCP / 多智能体 → 再看多智能体结构模式 → 再落到 Supervisor / Handoff 案例 → 最后补充 Agent Skills”** 的顺序学习。因为这章最容易乱的地方，不是代码写法，而是概念层级经常混在一起。
