...
- **`parser.invoke(...)`**：更偏 LangChain / Runnable 风格，适合和 `prompt | model | parser` 链式组合。你当前案例大多是这种写法。
...
#### 2.2.2 用法二：用 `get_format_instructions()` 自动生成格式说明
