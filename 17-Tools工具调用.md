...
**前置知识建议：** 建议已学习 [第 9 章 LangChain 概述与架构](9-LangChain概述与架构.md)、[第 10 章 LangChain 快速上手与 HelloWorld](10-LangChain快速上手与HelloWorld.md)、[第 11 章 Model I/O 与模型接入](11-Model-I-O与模型接入.md)、[第 13 章 提示词与消息模板](13-提示词与消息模板.md)、[第 15 章 LCEL 与链式调用](15-LCEL与链式调用.md)。如果已经学习 [第 16 章 记忆与对话历史](16-记忆与对话历史（含Redis基础）.md)，会更容易理解为什么工具结果经常也要回到消息流中继续参与后续推理。
...
<img src="images/17/17-1-1-1.jpeg" alt="未开启联网或工具时，对话产品无法给出实时天气，只能提示用户开启能力（示意图）" width="70%" />
