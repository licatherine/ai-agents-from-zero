...
<img src="images/9/9-1-1-1.png" style="zoom:50%;" alt="LangChain 主仓库（langchain-ai/langchain）GitHub Star 历史增长曲线，2023 初至 2025 初由近零增长至约 10 万+（star-history.com 风格图）"/>
...
<img src="images/9/9-1-2-1.png" style="zoom:50%;" alt="大语言模型单独使用时的典型局限：知识截止、无实时联网、难接私有数据与数据库、输出稳定性与工具调用等（示意图）"/>
...
<img src="images/9/9-2-4-1.png" style="zoom:50%;" alt="招聘场景中简历片段示意"/>
...
<img src="images/9/9-3-2-1.jpeg" style="zoom:70%;" alt="官方文档界面示意：ChatModel 相关说明与 1.x 版本语境下的模型接入入口"/>
